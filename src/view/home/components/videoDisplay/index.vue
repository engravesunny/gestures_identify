        ...
        <div class="video" :style="{ width:`${vWidth}%`,height:`${vHeight}%` }">
            <el-scrollbar ref="scrollbar" height="100%">
                <video
                    ...
                    src="https://gcore.jsdelivr.net/gh/engravesunny/CDN/video/2222.mp4"
                ...
                <video
                    ...
                    controls
                    style="object-fit: contain;width:100%;" 
                    src="https://gcore.jsdelivr.net/gh/engravesunny/CDN/video/3333.mp4"
                    @loadeddata="showVideo"
                ></video>
                <video
                    v-show="isShowVideo"
                    ...
                    controls
                    style="object-fit: contain;width:100%;" 
                    src="https://gcore.jsdelivr.net/gh/engravesunny/CDN/video/1111.mp4"
                    @loadeddata="showVideo"
                ></video>
                <video
                    v-show="isShowVideo"
                    ...
                    controls
                    style="object-fit: contain;width:100%;" 
                    src="https://gcore.jsdelivr.net/gh/engravesunny/CDN/video/4444.mp4"
                    @loadeddata="showVideo"
                ></video>
            </el-scrollbar>
        </div>
