...
const gameInfo = useSnakeGame()
const gameCol = gameInfo.gameCol
const gameRow = gameInfo.gameRow

console.log(111,gameInfo,gameCol,gameRow);


// 蛇头是否触碰到边界
export function hitFence(head, direction) {
    // 1.获取蛇头的位置
    // 2.检测蛇头是不是超出了游戏的范围
  ...
  // 蛇头是否触碰到自己
  export function hitSelf(head, bodies) {
